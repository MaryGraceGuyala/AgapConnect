...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO users_accounts (f_name, l_name, email_address, username, password, role) VALUES (:firstname, :lastname, :email, :username, :password, 'admin')");
            ...
            <div class="row d-flex d-lg-flex justify-content-center mb-5">
                <div class="col-md-8 col-xl-5">
                    <div class="card" style="padding: 12px;">
                        <div style="text-align: center;"><span style="font-family: Rubik, sans-serif;text-align: center;">Welcome, Admin!</span>
                            <p style="text-align: center;font-family: Rubik, sans-serif;">Please enter your personal details to create an account.</p>
                        </div>
                        <form method="post" action="admin-signup.php" style="padding: 8PX;">
