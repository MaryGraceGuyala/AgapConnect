...
$sql = "SELECT * FROM assistance_applications WHERE status = 'accepted'";
...
<head>
    ...
    <title>Kaagap Beneficiaries</title>
...
<body class="text-muted small pt-2 ps-1">
    ...
    <main id="main" class="main">
        <div class="page-title">
            <h1 style="font-family: Acme, sans-serif;font-size: 26px;">Kaagap Beneficiary</h1>
        </div>
        <section class="section dashboard">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4>Beneficiary Informations</h4>
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr class="text-center" style="border-style: none;background: rgb(211,227,201);font-family: ABeeZee, sans-serif;">
                                                ...
                                                <th class="datatable-descending" data-sortable="true" scope="col" aria-sort="descending" style="border-style: none;background: rgba(255,255,255,0);">Complete Diagnosis</th>                                                
                                                <th class="datatable-descending" data-sortable="true" scope="col" aria-sort="descending" style="border-style: none;background: rgba(255,255,255,0);">Patient type</th>
                                                <th class="datatable-descending" data-sortable="true" scope="col" aria-sort="descending" style="border-style: none;background: rgba(255,255,255,0);">Hospital</th>
                                                <th class="datatable-descending" data-sortable="true" scope="col" aria-sort="descending" style="border-style: none;background: rgba(255,255,255,0);">Type of Assistance</th>
                                                <th class="datatable-descending" data-sortable="true" scope="col" aria-sort="descending" style="border-style: none;background: rgba(255,255,255,0);">Complete Diagnosis</th>
                                                <th class="datatable-descending" data-sortable="true" scope="col" aria-sort="descending" style="border-style: none;background: rgba(255,255,255,0);">Representative Name</th>                                                
                                                <th class="datatable-descending" data-sortable="true" scope="col" aria-sort="descending" style="border-style: none;background: rgba(255,255,255,0);">Representative Age</th>
                                                <th class="datatable-descending" data-sortable="true" scope="col" aria-sort="descending" style="border-style: none;background: rgba(255,255,255,0);">Representative Relationship</th>
                                                <th class="datatable-descending" data-sortable="true" scope="col" aria-sort="descending" style="border-style: none;background: rgba(255,255,255,0);">Representative Contact Number</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($beneficiaries as $beneficiary): ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td><?php echo htmlspecialchars($beneficiary['fname']); ?></td>
                                                    <td><?php echo htmlspecialchars($beneficiary['mname']); ?></td>
                                                    <td><?php echo htmlspecialchars($beneficiary['lname']); ?></td>
                                                    ...
                                                    <td><?php echo htmlspecialchars($beneficiary['civil_status']); ?></td>
                                                    <td><?php echo htmlspecialchars($beneficiary['contact_number']); ?></td>
                                                    <td><?php echo htmlspecialchars($beneficiary['household_income']); ?></td>
                                                    <td><?php echo htmlspecialchars($beneficiary['medical_diagnosis']); ?></td>
                                                    <td><?php echo htmlspecialchars($beneficiary['patient_type']); ?></td>
                                                    <td><?php echo htmlspecialchars($beneficiary['hospital']); ?></td>
                                                    <td><?php echo htmlspecialchars($beneficiary['representative_name']); ?></td>
                                                    <td><?php echo htmlspecialchars($beneficiary['representative_age']); ?></td>
                                                    <td><?php echo htmlspecialchars($beneficiary['representative_relationship']); ?></td>
                                                    <td><?php echo htmlspecialchars($beneficiary['representative_contact_number']); ?></td>
                                                </tr>
                                            <?php endforeach; ?>     
                                        </tbody>
                                    </table>
