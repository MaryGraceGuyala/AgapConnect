...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("SELECT * FROM users_accounts WHERE username = :username AND role = 'member'");
            ...
            <div class="row d-flex d-lg-flex justify-content-center mb-5">
                <div class="col-md-8 col-xl-5">
                    <div class="card" style="padding: 12px;">
                        <div style="text-align: center;"><span style="font-family: Rubik, sans-serif;text-align: center;">Welcome&nbsp; back, Kaagap!</span>
                        ...
                        <form method="post" action="login.php" style="padding: 8PX;">
                            ...
                            <div style="text-align: center;font-family: Rubik, sans-serif;gap:5px;">
                                <span>Don't have an account?&nbsp;
                                    <a class="nav-links" href="members_signup.php">SIGN UP</a>
                                </span>
                            </div>
                        </form>
                    </div>
